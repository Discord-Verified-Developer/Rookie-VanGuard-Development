...
birb_love: "100",
 prefix:"$",
 xpsimbol: "<:exp:912095450163740733>",
 godpickaxe: "0",
 godpick: "0",
 goldkey: "0",
 godgem: "0",
...
hsnake: "0",
hsquid: "0",
 ssimbol: "<a:baddy:909868786591596634>",
 future: "0",
 ...
 green: "0",
  levelling:"false",
  hearts: "100",
  level_msg:"<:pikauwu:872340476655710209> {user.name} levelled up to {level}!",
  level_channel:"",
  level_roles:"",
  level_order:"",
  exp:"0",
...
esnipeOldMsg: "undefined",
 ...
 chat: "false",
  ...
  lotto: "false",
 trophy: "0",
 esimbol: "<:shine:911633389780606996>",
  lot:"false", 
 banklimit: "250000",
 prem: "false",
   ccmd: "",
...
ended:"false",
 ...
 bank: "1500",
 chest: "0",
 simbol: "<:shine:911633389780606996>",
 roles: "",
 emoji: "",
   afk: "",
  reason: "",
...
//for soundcloud non-link
  ...
  bored:"icon1",//Emoji for bored: fun command
  bye:"icon1",//Emoji for bye: fun command
  clap:"icon1",//Emoji for clap: fun command
  cuddle:"icon1",//Emoji for cuddle: fun command
  facepalm:"icon1",//Emoji for facepalm: fun command
  happy:"icon1",//Emoji for happy: fun command
  hug:"icon1",//Emoji for hug: fun command
  kill:"icon1",//Emoji for kill: fun command
  kiss:"icon1",//Emoji for kiss: fun command
  lick:"icon1",//Emoji for lick: fun command
  punch:"icon1",//Emoji for punch: fun command
  slap:"icon1",//Emoji for slap: fun command
  spank:"icon1",//Emoji for spank: fun command
  wanted:"icon1",//Emoji for wanted: fun command
  wasted:"icon1",//Emoji for wasted: fun command
  emod:"icon1",//Emoji for moderation: help command
  efun:"icon1",//Emoji for fun: help command
  eeconomy:"icon1",//Emoji for economy: help command
  erole:"icon1",//Emoji for RR: help command
  elevelling:"icon1",//Emoji for levelling: help command
  ewelcome:"icon1",//Emoji for welcome: help command
  eutility:"icon1",//Emoji for utility: help command
  einfo:"icon1",//Emoji for info: help command
  eticket:"icon1",//Emoji for ticket: help command
  //mute
  mrole:"Muted", //Original Mute Role
  //Warns
  wc:"0",//Warn Count
...
money:"0",//Wallet
  ...
  work_amounts:"",//Possible work amounts
  work_cd:"10m",//Cooldown for work
  symb:"<:musicc:894330235712057374>",//Money symbol
  bs:"<:musicc:894330235712057374>",//Bank symbol
  sb:"0",//Starting Bal
  sbd:"false",//Starting Claimed or no
  rs:"false",//Random spawns
  ra:"",//Spawn amounts
...
/*================*/
 ...
 hex: "#c89ffe",
  yes: "<a:yes:895767602071224380>", //dev only: custom emote, tickYes
    no: "<:cross:895767564322492488>", //dev only: custom emote, tickNo
    on: "<:on:895768764942012488>", //dev only: custom emote, switch_on
    off: "<:of:895768764547747900>", //dev only: custom emote, switch_off
    right: "<:arrow_right:869517484192055398>", //dev only: custom emote, arrow_right
    left: "<:arrow_left:869517513929662464>", //dev only: custom emote, arrow_left
    bright: "rightt|895347118213046282|true",
...
/*================*/
 ...
 welcomeChannel: "",
  ...
  goodbyeBg: "https://cdn.discordapp.com/attachments/850033801581297755/863810314135011338/blob-scene-haikei.png",
   pause: "⏸️ Paused.",
  resume: "▶️ Resumed!",
  skip: "⏩ Skipped!",  //Available {song}//
  stop: "⏹ Stopped.",  
